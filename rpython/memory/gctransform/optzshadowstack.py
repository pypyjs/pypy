...
class OptzShadowStackFrameworkGCTransformer(ShadowStackFrameworkGCTransformer):
    ...
    manipulated at each potential GC point.  The difference is that it churns
    a lot more CPU trying to avoid redundant updates of the root stack.
    ...
    def pop_roots(self, hop, livevars):
        ...
        # before being clobber by a subsequent reload.  In that case any
        # halfway decent compiler will the load via liveness analysis.
